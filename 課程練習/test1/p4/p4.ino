...
static int teammate1x = 999999, teammate1y = 999999, teammate2x = 999999, teammate2y = 999999, teammate3x = 999999, teammate3y = 999999;
...
void moving() {
  ...
  if (pastx == -1) {
    ...
    if (judgement > 0) {
      right(0);
      if (judgement > 120) delay(150);
      else if (judgement > 90)  delay(250);
      else  delay(100);
    }
    if (judgement < 0) {
      left(0);
      if (judgement < -120) delay(150);
      if (judgement < -90) delay(250);
      else  delay(100);
    }
    pastx = MyPosX;
    pasty = MyPosY;
