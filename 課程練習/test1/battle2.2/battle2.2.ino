...
#define TCP_IP_PHONE "192.168.0.70"
...
static int treasure1x = -1, treasure1y = -1, treasure2x = -1, treasure2y = -1, treasure3x = -1, treasure3y = -1, treasure4x = -1, treasure4y = -1;
...
void loop()
{
  ...
  if (letgo == true) {
    if ((stepfinish == 1 || stepfinish == 2) && mytreasurex != -1) {
      DstPosX = mytreasurex;
      DstPosY = mytreasurey;
      stepfinish = 3;
    }
    else if (stepfinish == 1) {
      if (treasure4x != -1 && treasure4y != -1) {
        backward(500);
        delay(700);
        left(650);
        delay(650);
      ...
      else if (treasure3x != -1 && treasure3y != -1) {
        backward(500);
        delay(700);
        left(650);
        delay(650);
      ...
      else if (treasure2x != -1 && treasure2y != -1) {
        backward(500);
        delay(700);
        left(650);
        delay(650);
      ...
      else if (treasure1x != -1 && treasure1y != -1) {
        backward(500);
        delay(700);
        left(650);
        delay(650);
