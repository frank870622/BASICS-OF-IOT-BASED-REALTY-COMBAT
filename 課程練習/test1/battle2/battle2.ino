  ...
  while (1)
  {
    if ((messageLen = wifiClient.available()) > 0) {
      ...
      if (sscanf(recv_buf, "Treasure:(%d, %d)(%d, %d)(%d, %d)(%d, %d)", &treasure1x, &treasure1y, &treasure2x, &treasure2y, &treasure3x, &treasure3y, &treasure4x, &treasure4y)) {
        steponedecide4(treasure1x, treasure1y, treasure2x, treasure2y, treasure3x, treasure3y, treasure4x, treasure4y);
        ...
        steponedecide3(treasure1x, treasure1y, treasure2x, treasure2y, treasure3x, treasure3y);
        Serial.print("DstPosX:");
        Serial.println(DstPosX);
        Serial.print("DstPosY:");
        Serial.println(DstPosY);
        ...
        steponedecide2(treasure1x, treasure1y, treasure2x, treasure2y);
        Serial.print("DstPosX:");
        Serial.println(DstPosX);
        Serial.print("DstPosY:");
        Serial.println(DstPosY);
        ...
        steponedecide1(treasure1x, treasure1y);
        Serial.print("DstPosX:");
        Serial.println(DstPosX);
        Serial.print("DstPosY:");
        Serial.println(DstPosY);
        ...
        sprintf(array2, "(%d, %d)", DstPosX, DstPosY);
        Serial.print(array1);
        Serial.println(array2);
        stepfinish = 1;
        if (letgo == true)send_mes(array1 , array2);
      }
